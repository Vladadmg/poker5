			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" id="table6">
				...
				<td width="50%" align="center" valign="top">
					<div align="center">
						<table border="0" cellpadding="0" cellspacing="0" width="80%" id="table32" >
							...
							<tr>
								<td class="text_normal">Vidéos des meilleurs tournois de poker</td>
								</tr>
							<tr>
				...
				<td width="50%" align="center" valign="top">
					<div align="center">
					  <table border="0" cellpadding="0" cellspacing="0" width="80%" id="table32" >
                        <tr>
                          <td class="categories" ><a href="category_home.php?cid=Coups de maîtres">&nbsp;
                                Coups de maîtres
                          </a></td>
                        </tr>
                        <tr>
                          <td class="text_normal">Les coups de maîtres, les parties de poker cultes</td>
                        </tr>
                        <tr>
					...
					<div align="center">
						<table border="0" cellpadding="0" cellspacing="0" width="80%" id="table32" >
							<tr>
								...
								<a href="category_home.php?cid=Débutant au Poker">&nbsp;Débutant au Poker</a></td>
							</tr>
							<tr>
								<td class="text_normal">Le poker pour les débutants</td>
								</tr>
							<tr>
								<td  class="text_normal" >								&nbsp;Derni&egrave;re vid&eacute;o ( <a href="http://www.poker5.tv/video-3-Le-poker-explique-aux-debutants">
								  Le poker expliqué aux déb...
								  </a>)</td>
							</tr>
							<tr>
								<td><img src="../images/1pix.gif" width="1" height="1"></td>
				...
				<td width="50%" align="center" valign="top">
					<div align="center">
						<table border="0" cellpadding="0" cellspacing="0" width="80%" id="table32" >
							...
							<tr>
								<td class="text_normal">Vidéos drôles en rapport avec le monde du poker</td>
								</tr>
							<tr>
				...
				<td width="50%" align="center" valign="top">
					<div align="center">
					  <table border="0" cellpadding="0" cellspacing="0" width="80%" id="table32" >
                        ...
                        <tr>
                          <td class="text_normal">Toutes les vidéos inclassables</td>
                        </tr>
                        <tr>
					...
					<div align="center">
						<table border="0" cellpadding="0" cellspacing="0" width="80%" id="table32" >
							<tr>
								...
								<a href="category_home.php?cid=Jeux vidéo">&nbsp;Jeux vidéo</a></td>
							</tr>
							<tr>
								<td class="text_normal">Jeux vidéo de poker sur console ou PC</td>
								</tr>
							<tr>
				...
				<td width="50%" align="center" valign="top">
					<div align="center">
					  <table border="0" cellpadding="0" cellspacing="0" width="80%" id="table32" >
                        <tr>
                          <td class="categories" ><a href="category_home.php?cid=Poker et Cinéma">&nbsp;
                                Poker et Cinéma
                          </a></td>
                        </tr>
                        <tr>
                          <td class="text_normal">Le poker dans le cinéma</td>
                        </tr>
                        <tr>
				...
				<td width="50%" align="center" valign="top">
					<div align="center">
						<table border="0" cellpadding="0" cellspacing="0" width="80%" id="table32" >
							...
							<tr>
								<td class="text_normal">Les pathologies liées au monde du jeu</td>
								</tr>
							<tr>
					...
					<div align="center">
						<table border="0" cellpadding="0" cellspacing="0" width="80%" id="table32" >
							<tr>
								...
								<a href="category_home.php?cid=Vos vidéos">&nbsp;Vos vidéos</a></td>
							</tr>
							<tr>
								<td class="text_normal">Les vidéos de passionnés de poker</td>
								</tr>
							<tr>
				...
				<td width="50%" align="center" valign="top">
					<div align="center">
					  <table border="0" cellpadding="0" cellspacing="0" width="80%" id="table32" >
                        <tr>
                          <td class="categories" ><a href="category_home.php?cid=Poker et société">&nbsp;
                                Poker et société
                          </a></td>
                        </tr>
                        <tr>
                          <td class="text_normal">Analyse de ce phénomène de société</td>
                        </tr>
                        <tr>
